...
#set_property  -dict {PACKAGE_PIN T2     IOSTANDARD LVCMOS18}                        [get_ports tx2_dclk_out_p]    ;# IO_L1N_T0L_N1_DBC_65
#set_property  -dict {PACKAGE_PIN T3     IOSTANDARD LVCMOS18}                        [get_ports tx2_strobe_out_p]    ;# IO_L1P_T0L_N0_DBC_65
#set_property  -dict {PACKAGE_PIN P3     IOSTANDARD LVCMOS18}                        [get_ports tx2_idata_out_p]   ;# IO_L2P_T0L_N2_65
#set_property  -dict {PACKAGE_PIN R3     IOSTANDARD LVCMOS18}                        [get_ports tx2_qdata_out_p]   ;# IO_L2N_T0L_N3_65
#set_property  -dict {PACKAGE_PIN U1     IOSTANDARD LVCMOS18}                        [get_ports tx1_dclk_out_p]   ;# IO_L3N_T0L_N5_AD15N_65
#set_property  -dict {PACKAGE_PIN U2     IOSTANDARD LVCMOS18}                        [get_ports tx1_strobe_out_p]   ;# IO_L3P_T0L_N4_AD15P_65
#set_property  -dict {PACKAGE_PIN T4     IOSTANDARD LVCMOS18}                        [get_ports tx1_idata_out_p]  ;# IO_L4N_T0U_N7_DBC_AD7N_65
#set_property  -dict {PACKAGE_PIN R4     IOSTANDARD LVCMOS18}                        [get_ports tx1_qdata_out_p]  ;# IO_L4P_T0U_N6_DBC_AD7P_SMBALERT_65
