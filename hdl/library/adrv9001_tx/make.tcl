...
ipx::infer_bus_interface {s_axis_tdata s_axis_tvalid s_axis_tready} xilinx.com:interface:axis_rtl:1.0 [ipx::current_core]
ipx::associate_bus_interfaces -busif s_axis -clock s_axis_aclk [ipx::current_core]
set_property name adrv9001_tx [ipx::get_bus_interfaces adrv9001_adrv9001_tx -of_objects [ipx::current_core]]
