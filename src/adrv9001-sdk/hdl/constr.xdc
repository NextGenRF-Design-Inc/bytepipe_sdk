...
set_property  -dict {PACKAGE_PIN T2     IOSTANDARD LVCMOS18}                        [get_ports gpio_sw[0]]    ;# IO_L1N_T0L_N1_DBC_65
set_property  -dict {PACKAGE_PIN T3     IOSTANDARD LVCMOS18}                        [get_ports gpio_sw[1]]    ;# IO_L1P_T0L_N0_DBC_65
set_property  -dict {PACKAGE_PIN P3     IOSTANDARD LVCMOS18}                        [get_ports gpio_sw[2]]   ;# IO_L2P_T0L_N2_65
set_property  -dict {PACKAGE_PIN R3     IOSTANDARD LVCMOS18}                        [get_ports gpio_sw[3]]   ;# IO_L2N_T0L_N3_65
set_property  -dict {PACKAGE_PIN U1     IOSTANDARD LVCMOS18}                        [get_ports gpio_pb[0]]   ;# IO_L3N_T0L_N5_AD15N_65
set_property  -dict {PACKAGE_PIN U2     IOSTANDARD LVCMOS18}                        [get_ports gpio_pb[1]]   ;# IO_L3P_T0L_N4_AD15P_65
set_property  -dict {PACKAGE_PIN T4     IOSTANDARD LVCMOS18}                        [get_ports gpio_pb[2]]  ;# IO_L4N_T0U_N7_DBC_AD7N_65
#set_property  -dict {PACKAGE_PIN R4     IOSTANDARD LVCMOS18}                        [get_ports adrv9001_tx2_strobe_n]  ;# IO_L4P_T0U_N6_DBC_AD7P_SMBALERT_65

set_property  -dict {PACKAGE_PIN T1     IOSTANDARD LVCMOS18}                        [get_ports gpio_led[0]]    ;## IO_L5N_T0U_N9_AD14N_65
set_property  -dict {PACKAGE_PIN R1     IOSTANDARD LVCMOS18}                        [get_ports gpio_led[1]]    ;## IO_L5P_T0U_N8_AD14P_65
set_property  -dict {PACKAGE_PIN M4     IOSTANDARD LVCMOS18}                        [get_ports gpio_led[2]]   ;## IO_L10N_T1U_N7_QBC_AD4N_65
set_property  -dict {PACKAGE_PIN M5     IOSTANDARD LVCMOS18}                        [get_ports gpio_led[3]]   ;## IO_L10P_T1U_N6_QBC_AD4P_65
set_property  -dict {PACKAGE_PIN L1     IOSTANDARD LVCMOS18}                        [get_ports gpio_led[4]]   ;## IO_L11N_T1U_N9_GC_65
set_property  -dict {PACKAGE_PIN L2     IOSTANDARD LVCMOS18}                        [get_ports gpio_led[5]]   ;## IO_L11P_T1U_N8_GC_65
#set_property  -dict {PACKAGE_PIN L3     IOSTANDARD LVCMOS18}                        [get_ports trig[0]]  ;## IO_L12N_T1U_N11_GC_65
#set_property  -dict {PACKAGE_PIN L4     IOSTANDARD LVCMOS18}                        [get_ports trig[1]]  ;## IO_L12P_T1U_N10_GC_65


# clocks

create_clock -name rx0_clk_in -period 2.00 [get_ports adrv9001_rx1_dclk_p]
create_clock -name rx1_clk_in -period 2.00 [get_ports adrv9001_rx2_dclk_p]
create_clock -name tx0_ref_clk_in -period 2.00 [get_ports adrv9001_tx1_ref_clk_p]
create_clock -name tx1_ref_clk_in -period 2.00 [get_ports adrv9001_tx2_ref_clk_p]
create_clock -name dev_clk_in -period 52.083 [get_ports adrv9001_dev_clk_in]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_clkgen/i_dev_ref_clk/I}]]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx_pclock/i_ibuf/O}]]

set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx0*i_rx_hs_clk/O}]]
set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx0*i_rx_ls_clk/O}]]
set_property USER_CLOCK_ROOT X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx0*i_rx_hs_clk/O}]]
set_property USER_CLOCK_ROOT X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx0*i_rx_ls_clk/O}]]

set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y2 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx0*i_int_clk/O}]]
set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y0 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx0*i_ls_int_clk/O}]]
set_property USER_CLOCK_ROOT X1Y2 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx0*i_int_clk/O}]]
set_property USER_CLOCK_ROOT X1Y0 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx0*i_ls_int_clk/O}]]

set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx1*i_rx_hs_clk/O}]]
set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx1*i_rx_ls_clk/O}]]
set_property USER_CLOCK_ROOT X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx1*i_rx_hs_clk/O}]]
set_property USER_CLOCK_ROOT X1Y1 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_rx1*i_rx_ls_clk/O}]]

set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y0 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx1*i_int_clk/O}]]
set_property CLOCK_DELAY_GROUP SERDES_CLK_GROUP_X1Y2 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx1*i_ls_int_clk/O}]]
set_property USER_CLOCK_ROOT X1Y0 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx1*i_int_clk/O}]]
set_property USER_CLOCK_ROOT X1Y2 [get_nets -of_objects [get_pins -hierarchical -filter {name =~ *i_tx1*i_ls_int_clk/O}]]

set_property CLOCK_REGION X1Y1 [get_cells -hierarchical -filter {name =~ *i_rx0*i_rx_hs_clk}]
set_property CLOCK_REGION X1Y1 [get_cells -hierarchical -filter {name =~ *i_rx0*i_rx_ls_clk}]
set_property CLOCK_REGION X1Y2 [get_cells -hierarchical -filter {name =~ *i_tx0*i_int_clk}]
set_property CLOCK_REGION X1Y0 [get_cells -hierarchical -filter {name =~ *i_tx0*i_ls_int_clk}]
set_property CLOCK_REGION X1Y1 [get_cells -hierarchical -filter {name =~ *i_tx0*i_mux_clk}]

set_property CLOCK_REGION X1Y1 [get_cells -hierarchical -filter {name =~ *i_rx1*i_rx_hs_clk}]
set_property CLOCK_REGION X1Y1 [get_cells -hierarchical -filter {name =~ *i_rx1*i_rx_ls_clk}]
set_property CLOCK_REGION X1Y0 [get_cells -hierarchical -filter {name =~ *i_tx1*i_int_clk}]
set_property CLOCK_REGION X1Y2 [get_cells -hierarchical -filter {name =~ *i_tx1*i_ls_int_clk}]
set_property CLOCK_REGION X1Y1 [get_cells -hierarchical -filter {name =~ *i_tx1*i_mux_clk}]

set_property loc BUFGCE_DIV_X0Y7  [get_cells -hierarchical -filter {name =~ *i_rx0*i_rx_hs_clk}]
set_property loc BUFGCE_DIV_X0Y6  [get_cells -hierarchical -filter {name =~ *i_rx0*i_rx_ls_clk}]
set_property loc BUFGCE_DIV_X0Y8  [get_cells -hierarchical -filter {name =~ *i_tx0*i_int_clk}]
set_property loc BUFGCE_DIV_X0Y1  [get_cells -hierarchical -filter {name =~ *i_tx0*i_ls_int_clk}]
set_property loc BUFGCTRL_X0Y15   [get_cells -hierarchical -filter {name =~ *i_tx0*i_mux_clk}]

set_property loc BUFGCE_DIV_X0Y4  [get_cells -hierarchical -filter {name =~ *i_rx1*i_rx_hs_clk}]
set_property loc BUFGCE_DIV_X0Y5  [get_cells -hierarchical -filter {name =~ *i_rx1*i_rx_ls_clk}]
set_property loc BUFGCE_DIV_X0Y3  [get_cells -hierarchical -filter {name =~ *i_tx1*i_int_clk}]
set_property loc BUFGCE_DIV_X0Y9  [get_cells -hierarchical -filter {name =~ *i_tx1*i_ls_int_clk}]
set_property loc BUFGCTRL_X0Y14   [get_cells -hierarchical -filter {name =~ *i_tx1*i_mux_clk}]