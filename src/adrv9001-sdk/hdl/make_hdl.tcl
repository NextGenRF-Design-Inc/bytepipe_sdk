...
# Define IP Name
set proj_name adrv9001-sdk

# Get Source Directory
set srcDir [file dirname [file normalize [ info script ] ] ]

# Create project
create_project $proj_name $proj_name/vivado -part xczu3cg-sbva484-1-e -force

# Add include tcl processes
source $srcDir/../../hdl_include.tcl

# Add IP Catalog
set_property ip_repo_paths ./$proj_name/library/ [current_fileset]
update_ip_catalog
...
update_compile_order -fileset sources_1
write_hw_platform -fixed -include_bit -force -file [file normalize $proj_name/${proj_name}.xsa]
