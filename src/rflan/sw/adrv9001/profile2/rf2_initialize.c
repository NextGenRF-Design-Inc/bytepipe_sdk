...
int rf2_initialize(adi_adrv9001_Device_t * adrv9001Device_0)
{
	...
	error_code = adi_adrv9001_InitAnalog(adrv9001Device_0, &rf2_init_2, ADI_ADRV9001_DEVICECLOCKDIVISOR_2);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	...
	error_code = adi_adrv9001_arm_Profile_Write(adrv9001Device_0, &rf2_init_2);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	
	error_code = adi_adrv9001_arm_PfirProfiles_Write(adrv9001Device_0, &rf2_init_2);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	...
	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_ORX, ADI_CHANNEL_1, 14, rf2_gainTableRows_ORX_1_CORRECTION_TABLE, 13, &lnaConfig_ORX_1_CORRECTION_TABLE, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	
	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_ORX, ADI_CHANNEL_2, 14, rf2_gainTableRows_ORX_2_CORRECTION_TABLE, 13, &lnaConfig_ORX_1_CORRECTION_TABLE, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	
	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_RX, ADI_CHANNEL_1, 255, rf2_gainTableRows_RX_1_CORRECTION_TABLE, 69, &lnaConfig_ORX_1_CORRECTION_TABLE, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	
	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_RX, ADI_CHANNEL_2, 255, rf2_gainTableRows_RX_2_CORRECTION_TABLE, 69, &lnaConfig_ORX_1_CORRECTION_TABLE, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	
	error_code = adi_adrv9001_Tx_AttenuationTable_Write(adrv9001Device_0, 3, 0, rf2_attenTableRows, 960);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
	...
	error_code = adi_adrv9001_gpio_ControlInit_Configure(adrv9001Device_0, &rf2_gpioCtrlInitCfg);
	ADI_HANDLE_ERROR(error_code, adrv9001Device_0);
