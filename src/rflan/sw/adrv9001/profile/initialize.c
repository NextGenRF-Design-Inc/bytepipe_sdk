...
int initialize(adi_adrv9001_Device_t * adrv9001Device_0)
{
	...
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	error_code = adi_adrv9001_Tx_OutputPowerBoost_Set(adrv9001Device_0, ADI_CHANNEL_1, Adrv9001Params.Tx1Boost);
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	...
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	error_code = adi_adrv9001_Radio_Carrier_Configure(adrv9001Device_0, ADI_RX, ADI_CHANNEL_1, &Adrv9001Params.Lo1Carrier);
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	...
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	error_code = adi_adrv9001_Radio_Carrier_Configure(adrv9001Device_0, ADI_RX, ADI_CHANNEL_2, &Adrv9001Params.Lo2Carrier);
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	...
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	error_code = adi_adrv9001_Radio_Carrier_Configure(adrv9001Device_0, ADI_TX, ADI_CHANNEL_1, &Adrv9001Params.Lo1Carrier);
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	error_code = adi_adrv9001_Radio_ChannelEnablementDelays_Configure(adrv9001Device_0, ADI_TX, ADI_CHANNEL_1, &delays_33);
	AUTOGENERATOR_ERROR_HANDLER(error_code);
	error_code = adi_adrv9001_cals_ExternalPathDelay_Set(adrv9001Device_0, ADI_CHANNEL_1, Adrv9001Params.Tx1ExternalPathDelay);
	AUTOGENERATOR_ERROR_HANDLER(error_code);
