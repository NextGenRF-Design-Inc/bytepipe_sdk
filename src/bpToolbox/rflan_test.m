...
if( ~strcmp(AdrvFirmwareVersion,'0.22.30.0'))
    error("Error");
end

AdrvAPIVersion = h.GetAdrvAPIVersion( );
if( ~strcmp(AdrvAPIVersion,'68.13.7'))
    error("Error");
end
...
h.GetCarrierFrequency(h.Tx2);
h.GetCarrierFrequency(h.Rx1);
h.GetCarrierFrequency(h.Rx2);
