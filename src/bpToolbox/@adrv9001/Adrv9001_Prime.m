...
function Adrv9001_Prime( obj ) % obj.adrv9001Device)
	...
	obj.status_string = sprintf("Priming channels.\n");
	[error_code] = obj.adrv9001Device.radio.Channel_ToPrimed(common_Port_e.RX, common_ChannelNumber_e.CHANNEL_1);
	[error_code] = obj.adrv9001Device.radio.Channel_ToPrimed(common_Port_e.RX, common_ChannelNumber_e.CHANNEL_2);
	[error_code] = obj.adrv9001Device.radio.Channel_ToPrimed(common_Port_e.TX, common_ChannelNumber_e.CHANNEL_1);
	[error_code] = obj.adrv9001Device.radio.Channel_ToPrimed(common_Port_e.TX, common_ChannelNumber_e.CHANNEL_2);
