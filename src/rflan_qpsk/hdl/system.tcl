...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
nextgenrf.com:user:axi_adrv9001:1.0\
...
xilinx.com:user:qpsk_rx:1.0\
xilinx.com:user:qpsk_tx:1.0\
"
...
proc create_hier_cell_qpsk_tx { parentCell nameHier } {
  ...
  # Create instance: qpsk_tx_0, and set properties
  set qpsk_tx_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:qpsk_tx:1.0 qpsk_tx_0 ]
  ...
  connect_bd_net -net Din_1 [get_bd_pins s_axis_tdata] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net adrv9002_0_tx1_axis_aclk [get_bd_pins clk] [get_bd_pins qpsk_tx_0/clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins rstn] [get_bd_pins qpsk_tx_0/reset_x]
  connect_bd_net -net qpsk_tx_0_ce_out_0 [get_bd_pins qpsk_tx_0/ce_out_0] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net qpsk_tx_0_dataout_im [get_bd_pins qpsk_tx_0/dataout_im] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net qpsk_tx_0_dataout_re [get_bd_pins qpsk_tx_0/dataout_re] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net qpsk_tx_0_validout [get_bd_pins m_axis_tvalid] [get_bd_pins qpsk_tx_0/validout]
  connect_bd_net -net tx_datardy [get_bd_pins qpsk_tx_0/dataready] [get_bd_pins util_vector_logic_1/Op2]
  connect_bd_net -net tx_valid_in [get_bd_pins s_axis_tvalid] [get_bd_pins qpsk_tx_0/validin]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins s_axis_tready] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins m_axis_tdata] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins qpsk_tx_0/clk_enable] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins qpsk_tx_0/datain] [get_bd_pins xlslice_0/Dout]
...
proc create_hier_cell_qpsk_rx { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk clk
  create_bd_pin -dir O -from 31 -to 0 m_axis_tdata
  create_bd_pin -dir O -from 0 -to 0 m_axis_tvalid
  create_bd_pin -dir I -type rst rsnt
  create_bd_pin -dir I -from 31 -to 0 s_axis_tdata
  create_bd_pin -dir I s_axis_tvalid
  ...
  # Create instance: qpsk_rx_0, and set properties
  set qpsk_rx_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:qpsk_rx:1.0 qpsk_rx_0 ]
  ...
  # Create port connections
  connect_bd_net -net adrv9002_0_tx1_axis_aclk [get_bd_pins clk] [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins qpsk_rx_0/clk]
  connect_bd_net -net c_shift_ram_0_Q [get_bd_pins c_shift_ram_0/Q] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net lsb_Dout [get_bd_pins lsb/Dout] [get_bd_pins qpsk_rx_0/datain_re]
  connect_bd_net -net msb_Dout [get_bd_pins msb/Dout] [get_bd_pins qpsk_rx_0/datain_im]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins rsnt] [get_bd_pins qpsk_rx_0/reset_x]
  connect_bd_net -net qpsk_rx_0_ce_out_0 [get_bd_pins qpsk_rx_0/ce_out_0] [get_bd_pins util_vector_logic_0/Op2] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net qpsk_rx_0_ce_out_1 [get_bd_pins qpsk_rx_0/ce_out_1] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net qpsk_rx_0_ctrlout_endOut [get_bd_pins qpsk_rx_0/ctrlout_endOut] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net qpsk_rx_0_ctrlout_startOut [get_bd_pins qpsk_rx_0/ctrlout_startOut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net qpsk_rx_0_ctrlout_validOut [get_bd_pins qpsk_rx_0/ctrlout_validOut] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net qpsk_rx_0_dataout [get_bd_pins qpsk_rx_0/dataout] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net qpsk_rx_0_rxdiagbus_nSynced [get_bd_pins qpsk_rx_0/rxdiagbus_nSynced] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net s_axis_tdata_1 [get_bd_pins s_axis_tdata] [get_bd_pins lsb/Din] [get_bd_pins msb/Din]
  connect_bd_net -net s_axis_tvalid_1 [get_bd_pins s_axis_tvalid] [get_bd_pins c_shift_ram_0/D] [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins xlconcat_0/In9]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins m_axis_tvalid] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins qpsk_rx_0/validin] [get_bd_pins util_vector_logic_1/Res] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins m_axis_tdata] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins qpsk_rx_0/clk_enable] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_0/In10] [get_bd_pins xlconstant_1/dout]
...
0#SD 0#SD 0#GPIO0 MIO#I2C 1#I2C 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1\
MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1\
MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD\
...
proc create_root_design { parentCell } {
  ...
  set adrv9002_0 [ create_bd_cell -type ip -vlnv nextgenrf.com:user:axi_adrv9001:1.0 adrv9002_0 ]
  ...
  connect_bd_net -net adrv9002_0_rx1_axis_aclk [get_bd_pins adrv9002_0/rx1_axis_aclk] [get_bd_pins qpsk_rx/clk] [get_bd_pins rx1_dma/s_axis_aclk]
  connect_bd_net -net adrv9002_0_rx1_axis_tdata [get_bd_pins adrv9002_0/rx1_axis_tdata] [get_bd_pins qpsk_rx/s_axis_tdata]
  connect_bd_net -net adrv9002_0_rx2_axis_aclk [get_bd_pins adrv9002_0/rx2_axis_aclk] [get_bd_pins rx2_dma/s_axis_aclk]
  connect_bd_net -net adrv9002_0_tx1_axis_aclk [get_bd_pins adrv9002_0/tx1_axis_aclk] [get_bd_pins qpsk_tx/clk] [get_bd_pins tx1_dma/m_axis_aclk]
  connect_bd_net -net adrv9002_0_tx1_axis_rstn [get_bd_pins adrv9002_0/tx1_axis_rstn] [get_bd_pins qpsk_tx/rstn]
  ...
  connect_bd_net -net qpsk_tx_m_axis_tdata [get_bd_pins adrv9002_0/tx1_axis_tdata] [get_bd_pins qpsk_tx/m_axis_tdata]
  connect_bd_net -net qpsk_tx_m_axis_tvalid [get_bd_pins adrv9002_0/tx1_axis_tvalid] [get_bd_pins qpsk_tx/m_axis_tvalid]
  connect_bd_net -net rsnt_1 [get_bd_pins adrv9002_0/rx1_axis_rstn] [get_bd_pins qpsk_rx/rsnt]
  connect_bd_net -net rx_data [get_bd_pins qpsk_rx/m_axis_tdata] [get_bd_pins rx1_dma/s_axis_data] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net rx_valid [get_bd_pins qpsk_rx/m_axis_tvalid] [get_bd_pins rx1_dma/s_axis_valid]
  connect_bd_net -net s_axis_tvalid_1 [get_bd_pins adrv9002_0/rx1_axis_tvalid] [get_bd_pins qpsk_rx/s_axis_tvalid]
  connect_bd_net -net sys_cpu_clk [get_bd_pins adrv9002_0/s_axi_aclk] [get_bd_pins axi_cpu_interconnect/ACLK] [get_bd_pins axi_cpu_interconnect/M00_ACLK] [get_bd_pins axi_cpu_interconnect/M01_ACLK] [get_bd_pins axi_cpu_interconnect/M02_ACLK] [get_bd_pins axi_cpu_interconnect/M03_ACLK] [get_bd_pins axi_cpu_interconnect/M04_ACLK] [get_bd_pins axi_cpu_interconnect/S00_ACLK] [get_bd_pins axi_hp1_interconnect/aclk] [get_bd_pins cpu/m_axi_aclk] [get_bd_pins rx1_dma/m_dest_axi_aclk] [get_bd_pins rx1_dma/s_axi_aclk] [get_bd_pins rx2_dma/m_dest_axi_aclk] [get_bd_pins rx2_dma/s_axi_aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins tx1_dma/m_src_axi_aclk] [get_bd_pins tx1_dma/s_axi_aclk] [get_bd_pins tx2_dma/m_src_axi_aclk] [get_bd_pins tx2_dma/s_axi_aclk]
  ...
  connect_bd_net -net tx_data_in [get_bd_pins qpsk_tx/s_axis_tdata] [get_bd_pins tx1_dma/m_axis_data]
  connect_bd_net -net tx_valid_in [get_bd_pins qpsk_tx/s_axis_tvalid] [get_bd_pins tx1_dma/m_axis_valid]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins qpsk_tx/s_axis_tready] [get_bd_pins tx1_dma/m_axis_ready]
